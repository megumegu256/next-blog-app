...
- 公開 URL にアクセスするとまず表示されるページ。ここでは現在投稿されている記事それぞれの投稿年月日、タイトル、本文、カテゴリが表示される。
- "投稿時間でソート"ボタンをクリックすると、現在表示されている記事の投稿時間について並び変えることができる。ボタンをクリックするたびに、昇順、降順を切り替得ることができる。
